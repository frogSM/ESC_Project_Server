...
public class Constants {
	...
	/** 자주하는 질문 중 best 5 질답 요청**/
	public final static String requestBest5QADB = "requestBest5QADB";
	
	/** 자주하는 질문 중 교환&환불 질답 요청 **/
	public final static String requestExchangeAndRefundQADB = "requestExchangeAndRefundQADB" ;
	
	/** 자주하는 질문 중 결제 질답 요청 **/
	public final static String requestPaymentQADB = "requestPaymentQADB";
